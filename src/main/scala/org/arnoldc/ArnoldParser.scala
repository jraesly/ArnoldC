...
class ArnoldParser extends Parser {
  ...
  val DeclareInt = "number"
  val SetInitialValue = "initial value"
  val BeginMain = "start"
  val PlusOperator = "plus"
  val MinusOperator = "minus"
  val MultiplicationOperator = "times"
  val DivisionOperator = "divided by"
  val EndMain = "stop"
  val Print = "display"
  val Read = "read"
  val AssignVariable = "declare x-factor"
  val SetValue = "set value"
  val EndAssignVariable = "stop declaring the x-factor"
  val False = "false"
  val True = "true"
  val EqualTo = "equals"
  ...
  val Else = "else"
  val EndIf = "stop if"
  val While = "keep trying"
  val EndWhile = "stop trying"
  val DeclareMethod = "start method"
  val MethodArguments = "method args"
  val Return = "return"
  val EndMethodDeclaration = "end method"
  val CallMethod = "call method"
  val NonVoidMethod = "non void method"
  val AssignVariableFromMethodCall = "assign var from method"
  val Modulo = "mod"
